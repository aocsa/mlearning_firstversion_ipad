...
namespace MLearning.UnifiedTouch.Views
{
	...
	public class LoginView : MvxViewController
	{
		...
		public override void ViewDidLoad()
		{
			...
			loadLogo ();
			//logo
			//Add (getResource (new CGRect (20, 715, 34, 35), "iOS Resources/bigLogo.png"));
		...
		{
			var bigLogo = Constants.makeImageView (new CGRect (408, 280, 208, 208), "iOS Resources/bigLogo.png");
			Add (bigLogo);
			UIView.Animate (duration: 1,
				delay: 0,
				options: UIViewAnimationOptions.CurveEaseIn,
				animation: () => {
					bigLogo.Frame = new CGRect (20,705,44,45);
				},
				completion: () => {
					loadForm();
					//bigLogo.Hidden = true;
					...
					//bigLogo.Dispose ();
					//Add (Constants.makeImageView (new CGRect (20, 715, 34, 35), "iOS Resources/logo.png"));
					UIView.Animate (duration: 1,
						animation: () => {
							Form.Alpha = 1;
						});
		...
		private void loadForm()
		{
			...
			Form = Constants.makeImageView (new CGRect (379, 251, 266, 267), "iOS Resources/formulario.png");
			//separator 1
			Form.Add (Constants.makeImageView (new CGRect (398 - Form.Frame.X , 410 - Form.Frame.Y , 228, 1) , "iOS Resources/separator.png"));
			//separator 2
			Form.Add (Constants.makeImageView (new CGRect (398 - Form.Frame.X , 457 - Form.Frame.Y , 228, 1) , "iOS Resources/separator.png"));

			login = Constants.makeLabel (new CGRect (444 - Form.Frame.X, 290 - Form.Frame.Y, 130, 53),
			...
			register = Constants.makeLabel (new CGRect (529 - Form.Frame.X, 476 - Form.Frame.Y, 77, 17),
			...
			loginButton.Frame = new CGRect (604 - Form.Frame.X, 428 - Form.Frame.Y, 22, 23);
			loginButton.SetBackgroundImage (UIImage.FromFile ("iOS Resources/boton.png"), UIControlState.Normal);
			Form.Add (loginButton);

			username = Constants.makeTextField (new CGRect (409 - Form.Frame.X, 388 - Form.Frame.Y, 180, 15), 
				Constants.LoginTextColor, "Usuario", Font.Light, 16);
			username.BackgroundColor = UIColor.Clear;
			Form.Add (username);


			password = Constants.makeTextField (new CGRect (407 - Form.Frame.X, 434 - Form.Frame.Y, 180, 15),
		...
		private void beginEditing (bool editing)
		{
			...
			CGRect newFrame = new CGRect (currentFrame.X, currentFrame.Y + move, currentFrame.Width, currentFrame.Height);
		...
		{
			Text_lu = Constants.makeLabel (new CGRect (17, 20, 80, 16), UIColor.White, UITextAlignment.Left, Font.Regular, 16);
			Text_lu.Text = "Aplicación";

			Text_ru = Constants.makeLabel (new CGRect (918, 20, 88, 13), UIColor.White, UITextAlignment.Right, Font.Regular, 16);
			Text_ru.Text = "Learn More";

			Text_rb = Constants.makeLabel (new CGRect (491, 738, 506, 16), UIColor.White, UITextAlignment.Right, Font.Regular, 14);
